        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-lg">
              Master any subject with AI-powered flashcards, quizzes, study guides, and personalized tutoring. Try it free—no signup required.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                href="/study"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-orange-500 to-amber-600 text-white font-bold rounded-lg hover:opacity-90 transition-all shadow-lg transform hover:scale-105"
              >
                Try for Free
            ...
            <p className="text-sm text-gray-500 mt-6">
              ✨ Explore all features instantly • No credit card needed • Start learning in seconds
            </p>
          </div>
